...
module.exports = function (THREE) {
	...
	THREE.InstancedMesh.prototype.setColorAt = function (index, color, colorId) {
		...
		if (!colorId) {
			...
			this.geometry.attributes.instanceColor2.setXYZ(
				index,
				Math.floor(color.r * 255),
				Math.floor(color.g * 255),
				Math.floor(color.b * 255)
	...
	THREE.InstancedMesh.prototype.needsUpdate = function (attribute) {
		...
		switch (attribute) {
			...
			case 'colors':
				...
				this.geometry.attributes.instanceColor2.needsUpdate = true;
